...
class DashboardDark extends StatefulWidget {
  ...
  @override
  _DashboardDarkState createState() => _DashboardDarkState();
}
...
class _DashboardDarkState extends State<DashboardDark> {
  ...
  void initState() {
    ...
    super.initState();
    Provider.of<Dashboards>(context, listen: false).fetchDashboard("dark");
    setState(() {
      _isLoading = true;
    });
  }
                  ...
                  return Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: GestureDetector(
                        ...
                        child: GridTile(
                          child: Image.asset('img/icons/${index + 1}.png'),
                        ),
                      ),
                    ),
                  );
